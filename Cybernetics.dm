...
obj/Module
	...
	proc/Enable_Module(mob/P)
		...
		P.SetStatModifierSource("cybernetic_module", list("Strength" = StrP, "Durability" = EndP, "Speed" = SpdP, "Force" = PowP, "Resistance" = ResP, "Accuracy" = OffP), "\ref[src]", "equipped_module")
	...
	proc/Disable_Module(mob/P)
		...
		P.Def -= DefP
		P.regen/=Regx;P.recov/=Recx
		P.RemoveStatModifierSource("cybernetic_module", "\ref[src]")
		P.Decline-=Life_Add;P.leech_rate/=Leechx;P.Regenerate-=Regenerate_Add;P.Lungs-=Lungs;P.Cyber_Fly-=Cyber_Fly
		P.Nanite_Repair-=Nanite_Repair;P.Cyber_Scanner-=Scanner;P.Cyber_Force_Field-=Cyber_Force_Field;\
		P.Blast_Absorb-=Blast_Absorb
		P.paralysis_immune-=paralysis_immunity
	...
	New()
		spawn if(ismob(loc))
			...
			if(suffix)
				...
				M.SetStatModifierSource("cybernetic_module", list("Strength" = StrP, "Durability" = EndP, "Speed" = SpdP, "Force" = PowP, "Resistance" = ResP, "Accuracy" = OffP), "\ref[src]", "equipped_module")
