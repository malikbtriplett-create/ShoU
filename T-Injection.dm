...
mob/proc
	...
	SyncTInjectionStatModifiers()
		RemoveAllStatModifierSources("t_injection_spider")
		RemoveAllStatModifierSources("t_injection_scorpion")
		RemoveAllStatModifierSources("t_injection_snake")
		RemoveAllStatModifierSources("t_injection_regeneration")
		RemoveAllStatModifierSources("t_injection_undying")
		if(!islist(T_Injections)) return
		if("Spider" in T_Injections) SetStatModifierSource("t_injection_spider", list("Strength" = 2, "Accuracy" = 2, "Resistance" = -3), null, "persistent_injection")
		if("Scorpion" in T_Injections) SetStatModifierSource("t_injection_scorpion", list("Accuracy" = 2), null, "persistent_injection")
		if("Snake" in T_Injections) SetStatModifierSource("t_injection_snake", list("Speed" = 2), null, "persistent_injection")
		if("Regeneration" in T_Injections) SetStatModifierSource("t_injection_regeneration", list("Force" = -3), null, "persistent_injection")
		if("Undying" in T_Injections) SetStatModifierSource("t_injection_undying", list("Resistance" = -3), null, "persistent_injection")
	...
	Apply_t_spider(remove=0)
		if(remove)
			if("Spider" in T_Injections)
				...
				Off -= 2
				Res -= -3
				RemoveStatModifierSource("t_injection_spider")
			...
			if(!("Spider" in T_Injections))
				...
				Off += 2
				Res += -3
				SetStatModifierSource("t_injection_spider", list("Strength" = 2, "Accuracy" = 2, "Resistance" = -3), null, "persistent_injection")
				Original_Decline*=0.9
				Decline*=0.9
	...
	Apply_t_scorpion(remove=0)
		if(remove)
			if("Scorpion" in T_Injections)
				...
				Off -= 2
				Def -= -2
				RemoveStatModifierSource("t_injection_scorpion")
				Original_Decline/=0.9
				Decline/=0.9
		else
			if(!("Scorpion" in T_Injections))
				...
				Off += 2
				Def += -2
				SetStatModifierSource("t_injection_scorpion", list("Accuracy" = 2), null, "persistent_injection")
				Original_Decline*=0.9
				Decline*=0.9
	...
	Apply_t_snake(remove=0)
		if(remove)
			if("Snake" in T_Injections)
				...
				Spd -= 2
				Def -= 2
				RemoveStatModifierSource("t_injection_snake")
				Original_Decline/=0.9
				Decline/=0.9
		else
			if(!("Snake" in T_Injections))
				...
				Spd += 2
				Def += 2
				SetStatModifierSource("t_injection_snake", list("Speed" = 2), null, "persistent_injection")
				Original_Decline*=0.9
				Decline*=0.9
	...
	Apply_t_regeneration(remove=0)
		if(remove)
			if("Regeneration" in T_Injections)
				...
				regen /= 2
				Pow -= -3
				RemoveStatModifierSource("t_injection_regeneration")
				Original_Decline/=0.8
				Decline/=0.8
		else
			if(!("Regeneration" in T_Injections))
				...
				regen *= 2
				Pow += -3
				SetStatModifierSource("t_injection_regeneration", list("Force" = -3), null, "persistent_injection")
				Original_Decline*=0.8
				Decline*=0.8
	Apply_t_undying(remove=0)
		if(remove)
			if("Undying" in T_Injections)
				...
				Regenerate -= 1.3
				Res -= -3
				RemoveStatModifierSource("t_injection_undying")
				Original_Decline/=0.8
				Decline/=0.8
		else
			if(!("Undying" in T_Injections))
				...
				Regenerate += 1.3
				Res += -3
				SetStatModifierSource("t_injection_undying", list("Resistance" = -3), null, "persistent_injection")
				Original_Decline*=0.8
				Decline*=0.8
obj/items/T_Spider
	Stealable=1
